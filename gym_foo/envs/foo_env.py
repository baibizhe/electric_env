...
from utils import rank, select_clear_amount, calculate_total_amount


class FooEnv(gym.Env):

    def __init__(self, min_buyer_price=300, max_seller_price=400, min_seller_price=300, max_buyer_price=370, \
                  seller_data="data/seller_data", buyer_data="data/buyer_data"):
        ...
        self.buyer_price = np.random.uniform(self.min_buyer_price, self.max_buyer_price,
                                             self.num_of_buyer)  # 找到当前状态的买方价格
